...
namespace Proyectores.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_especialidad,nombre")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_especialidad,nombre")] Especialidad especialidad)
        {
            if (ModelState.IsValid)
            {
